...
public class ThreadDemo4 {
    ...
    public static void main(String[] args){
        ...
        //thread.run();//就是直接调用方法，同一个线程中
        
        //第二种
        //表明: start()方法重新创建了一个线程,在main方法执行结束后,由于start()方法创建的线程没有运行结束,
        //因此main线程未能退出,直到线程thread也执行完毕.这里要注意,默认创建的线程是用户线程(非守护线程)
        //thread.start();
        ...
        //第四种
        //用户线程可以被System.exit(0)正常  System.exit(1)异常 强制kill掉,所以也只打印出七句
        thread.start();
    ...
    public static class ThreadDemo extends Thread{
        ...
        public void run() {
            ...
            System.out.println("ThreadDemo thread is over");
        }
    }
}
