 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://cxf.jpa.spring.hf.com/", wsdlLocation = "http://127.0.0.1:8080/HelloMaven/cxf/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://cxf.jpa.spring.hf.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8080/HelloMaven/cxf/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://cxf.jpa.spring.hf.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cxf.jpa.spring.hf.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
